...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/abdi_mlops_project-tests-ci.yml) 
...
Links:
* [Staging model in UC](https://adb-1037601593204228.8.azuredatabricks.net/explore/data/models/staging/abdi_mlops_project/abdi_mlops_project-model)
* [Prod model in UC](https://adb-1037601593204228.8.azuredatabricks.net/explore/data/models/prod/abdi_mlops_project/abdi_mlops_project-model)
. 
